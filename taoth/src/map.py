...
class MapManager:
    ...
    def __init__(self, screen, player):
        ...
        self.register_map("world", portals=[
            Portal(from_world="world", origin_point="enter_house", target_world="house1", teleport_point="spawn_house"),
        ...
        self.register_map("house1", portals=[
            Portal(from_world="house1", origin_point="exit_house", target_world="world", teleport_point="enter_house_exit")
        ])
        self.register_map("house2", portals=[
            Portal(from_world="house2", origin_point="exit_house", target_world="world", teleport_point="enter_house_exit2"),
            Portal(from_world="house2", origin_point="enter_cave", target_world="cave_house1", teleport_point="spawn_cave")
        ])
        self.register_map("cave_house1", portals=[
            Portal(from_world="cave_house1", origin_point="exit_cave", target_world="house2", teleport_point="enter_cave_exit")
        ])
